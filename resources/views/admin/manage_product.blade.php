                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="technical_specs" class="control-label mb-1"> Technical Specification</label>
                                    <textarea id="technical_specs" name="technical_specs" type="text" class="form-control" aria-required="true" aria-invalid="false" required>{{$technical_specs}}</textarea>
                                </div>
                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <label for="attr_image" class="control-label mb-1">
                                                    &nbsp;&nbsp;&nbsp;</label>
                                                @if($loop_count_num==2)
                                                    <button type="button"  class="btn mb-3 btn-success btn-lg" onclick="add_more()">
                                                        <i class="fa fa-plus"></i>&nbsp; Add</button>
                                                @else
