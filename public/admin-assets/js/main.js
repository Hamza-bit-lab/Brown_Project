...
function update_payment_status(id) {
    ...
    var $paymentStatus = jQuery('#payment_status');
    var newPaymentStatus = $paymentStatus.val();
    var originalPaymentStatus = jQuery('#original_payment_status').val();

    if (check) {
        // console.log("New Payment Status: " + newPaymentStatus);
        window.location.href = '/admin/update_payment_status/' + newPaymentStatus + '/' + id;
    } else {
        if (newPaymentStatus !== originalPaymentStatus) {
            $paymentStatus.val(originalPaymentStatus);
            // console.log("Reverted to Original Payment Status: " + originalPaymentStatus);
        } else {
            console.log("No change in Payment Status.");
        }
    }
}
